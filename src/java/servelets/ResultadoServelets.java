...
//            ResultadoAluno resultadoAluno = new ResultadoAluno(matricula, nome, totalPontos);
//            resultadoService.salvarResultado(resultadoAluno);
//
//            // Carregar todos os resultados do arquivo JSON
//            List<ResultadoAluno> todosResultados = resultadoService.carregarResultados();
//            
//            
//            System.out.println("Resultados carregados: " + todosResultados);
//            request.setAttribute("resultados", todosResultados);
...
//            
//
//            // Adiciona os resultados ao objeto de requisição
//            request.setAttribute("resultados", todosResultados);
//
...
public class ResultadoServelets extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (matricula != null && nome != null) {
            ...
            // Verificar se os resultados foram carregados corretamente
            if (todosResultados != null && !todosResultados.isEmpty()) {
                ...
                response.sendError(HttpServletResponse.SC_NOT_FOUND, "Nenhum resultado encontrado.");
            }
        } else {
            response.sendError(HttpServletResponse.SC_BAD_REQUEST, "Matrícula e nome são obrigatórios.");
        }
